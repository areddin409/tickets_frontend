...
export const listEvents = async (
  ...
  // Handle json-server response (array) vs Spring Boot response (pagination object)
  if (Array.isArray(responseBody)) {
    // json-server returns a simple array, wrap it in Spring Boot format
    return {
      ...
      first: true,
      last: true,
      numberOfElements: responseBody.length,
      empty: responseBody.length === 0,
      pageable: {
      ...
      sort: { empty: true, sorted: false, unsorted: true },
    } as SpringBootPagination<EventSummary>;
  }
...
export const listPublishedEvents = async (
  ...
  if (Array.isArray(responseBody)) {
    return {
      ...
      sort: { empty: true, sorted: false, unsorted: true },
    } as SpringBootPagination<PublishedEventSummary>;
  }
...
export const listTickets = async (
  ...
  if (Array.isArray(responseBody)) {
    return {
      ...
      sort: { empty: true, sorted: false, unsorted: true },
    } as SpringBootPagination<TicketSummary>;
  }
